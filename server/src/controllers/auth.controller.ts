...
export class AuthController {
  ...
  public register = async (req: TypedRequestBody<User>, res: Response) => {
    try {
      ...
      ResponseFormatter.success(res, "User created successfully");
    } catch (err) {
  ...
  public login = async (req: TypedRequestBody<User>, res: Response) => {
    try {
      ...
      ResponseFormatter.success(res, "Login successful");
    } catch (err) {
  ...
  public me = async (req: Request, res: Response) => {
    try {
      ...
      ResponseFormatter.success(res, safeUser, "User fetched successfully");
    } catch (err) {
